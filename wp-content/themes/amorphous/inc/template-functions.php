 ...
 * @return array
 */
function amorphous_body_classes( $classes ) {
...
add_filter( 'body_class', 'amorphous_body_classes' );

/**
 * Add a pingback url auto-discovery header for singularly identifiable articles.
 */
function amorphous_pingback_header() {
	if ( is_singular() && pings_open() ) {
		echo '<link rel="pingback" href="', esc_url( get_bloginfo( 'pingback_url' ) ), '">';
	}
}
add_action( 'wp_head', 'amorphous_pingback_header' );
...
if ( ! function_exists( 'theme_breadcrumb' ) ) {
	function theme_breadcrumb( $showhome = true, $separatorclass = false ) {
